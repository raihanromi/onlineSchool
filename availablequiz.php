  ...
  <div class="row g-0">
    <div class="col-md-8">
      <div class="card-body">
        ...
        <a class="btn btn-primary text-white font-weight-bolder float-right" href="attendquiz.php?course_code='.$course_code.'">View</a>
      </div>
    </div>
  </div>
</div>';
    ...
    echo "<script> alert('No quiz active right now!')</script>";
}
